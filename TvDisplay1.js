...
import logoImage from '../eta.png';

export function TvDisplay1() {
    ...
    */
    ...
    const fetchtotalemployees = async () => {
        try {
            const response = await axios.get('http://192.168.29.149:4000/fetchtotalemployees');
    ...
    const fetchtotalpresentemployees = async () => {
        try {
            const response = await axios.get('http://192.168.29.149:4000/fetchtotalpresentemployees');
            const data = response.data;
    ...
    const fetchtotalabsentemployees = async () => {
        try {
            const response = await axios.get('http://192.168.29.149:4000/fetchtotalabsentemployees');
            const data = response.data;
    ...
    const fetchtotalactiveemployees = async () => {
        try {
            const response = await axios.get('http://192.168.29.149:4000/fetchtotalactiveemployees');
            const data = response.data;
    ...
    const fetchmtdavgoutput = async () => {
        try {
            const response = await axios.get('http://192.168.29.149:4000/fetchmtdavgoutput');
            const data = response.data;
    ...
    const fetchtotalfgoutput = async () => {
        try {
            const response = await axios.get('http://192.168.29.149:4000/fetchtotalfgoutput');
            const data = response.data;
    ...
    const fetchshopfloorppp = async () => {
        try {
            const response = await axios.get('http://192.168.29.149:4000/fetchshopfloorppp');
            const data = response.data;
    ...
    const fetchmtdppp = async () => {
        try {
            const response = await axios.get('http://192.168.29.149:4000/fetchmtdppp');
            const data = response.data;
            setMtdPpp(data.resk);
        } catch (error) {
            console.error('Error fetching total workers:', error);
    ...
    const fetchfgoutputslide = async () => {
        try {
            const response = await axios.get('http://192.168.29.149:4000/fetchfgoutputslide');
            const data = response.data;
    ...
    const fetchplanvstargetslide = async () => {
        try {
            const response = await axios.get('http://192.168.29.149:4000/fetchplanvstargetslide');
            const data = response.data;
    ...
    const fetchitemwisepppslide = async () => {
        try {
            const response = await axios.get('http://192.168.29.149:4000/fetchitemwisepppslide');
            const data = response.data;
            console.log('Data from the API:', data);
            setIWPPPSlide(data);
    ...
    const fetchmtdpppslide = async () => {
        try {
            const response = await axios.get('http://192.168.29.149:4000/fetchmtdpppslide');
            const data = response.data;
            console.log('Data from the API:', data);
            setMTDPPPSlide(data);
    ...
    const fetchTop10Workersslide = async () => {
        try {
            const response = await axios.get('http://192.168.29.149:4000/fetchTop10Workersslide');
            const data = response.data;
            console.log('Data from the API:', data);
            setTWSlide(data);
    ...
    const fetchTop10Workersmtdslide = async () => {
        try {
            const response = await axios.get('http://192.168.29.149:4000/fetchTop10Workersmtdslide');
            const data = response.data;
            console.log('Data from the API:', data);
            setTWMTDSlide(data);
                                ...
                                <div className="cardtv" id="breathing-button">
                                    <div className="cardtv-body">
                                        <div className="row">
                                            ...
                                            <div className="col-md-3">
                                                <h5 className="text-dark"><b>{(totalFgOutput / totalActiveEmployees).toFixed(2)}</b></h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="cardtv" id="breathing-button">
                                    <div className="cardtv-body">
                                        <div className="row">
                                            ...
                                            <div className="col-md-3">
                                                <h5 className="text-dark"><b>{(mtdPpp / totalFgOutput).toFixed(2)}</b></h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
